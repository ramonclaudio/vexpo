...
| Translucency counted, not just color                              | pass. The test composites translucent tones over what is behind them before measuring                                                                                                           |
...
| Apple asks                     | Verdict                                                                                                                                         |
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Color is never the only signal | pass. Status rows pair the color with a symbol and a word, and the CLI keeps a two-character tag on every line so `NO_COLOR` output still reads |
...
| Rule                                                     | Verdict                                                                                                                                                                                                                                                                                                                                  |
| -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Nothing depends on color alone                           | pass. `ok` / `xx` / `!!` / `--` on every line, measured in `output.test.ts`                                                                                                                                                                                                                                                              |
...
and the color and animation gates in both the CLI and the scaffolder.
